...
public class ScoreStudentSem1Controller extends SidebarUserController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        for (Integer integer : Semester_SubjectDAO.getInstance().selectBySemester(1)) {
...
//        tcPercent.setCellFactory(TextFieldTableCell.forTableColumn(new FloatStringConverter()));
        ...
        tcStatus.setCellValueFactory(cellData -> {
            ...
            if (percent < 40) {
                ...
                return new SimpleStringProperty("EXCELLENT");
            }
        });
