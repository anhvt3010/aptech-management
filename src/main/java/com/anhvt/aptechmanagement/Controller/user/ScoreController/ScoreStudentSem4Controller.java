...
public class ScoreStudentSem4Controller  extends SidebarUserController implements Initializable {
    @FXML
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        for (Integer integer : Semester_SubjectDAO.getInstance().selectBySemester(4)) {
